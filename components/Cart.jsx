...
import { AiOutlineMinus, AiOutlineLeft, AiOutlinePlus, AiOutlineShopping, AiFillDelete } from 'react-icons/ai';
    ...
    <div className='cart-wrapper' ref={cartRef}>
      <div className='cart-container'>
        ...
        <div className='product-container'>
          {cartItems.length >= 1 && cartItems.map((item) => (<div className='product' key={item._id}>
        ...
        {cartItems.length >= 1 && (
          <div className='cart-bottom'>
            ...
            <div className='btn-container'>
              <button className='btn' onClick={handleCheckout} type="button">Pay with stripe</button>
            </div>
          </div>
        )}
      </div>
